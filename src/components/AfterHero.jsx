...
export const AfterHero = () => {
  return (
    <section>
      <div className="xl:w-[70%] px-5 py-10 xl:px-20 xl:py-20 flex flex-col xl:flex-row mx-auto xl:justify-around lg:text-center">
        ...
        <div className="xl:pt-5 xl:w-[50%] text-center">
          <h4 className={`${outfitRegular.className} xl:text-left mx-auto text-center text-slate-800 text-[15px] xl:text-[16px] lg:w-[70%]`}>
