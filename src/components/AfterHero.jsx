      ...
      <div className="px-5 py-10 xl:px-20 xl:py-20 flex flex-col mx-auto xl:justify-around lg:text-center items-center text-center mt-0 Scrn425:mt-10 md:mt-28 lg:-mt-0 lg:w-[70%]">
        ...
        <div className='flex flex-col'>
          ...
          <div className="xl:pt-5 text-center mx-auto" id='AFTitle'>
            <h4 className={`${outfitRegular.className} xl:w-[50%] text-center mx-auto text-slate-800 text-[15px] md:text-[18px] xl:text-[18px] lg:w-[70%] md:w-[60%]`}>
          ...
          <div id='AFImage' className="w-full h-full relative">
            <Image
