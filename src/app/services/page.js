...
const page = () => {
  return (
    <section >
      ...
      {/* Section */}
      <section className='px-5 xl:px-5 mt-40 md:mt-0 lg:mt-0 xl:mt-0 md:px-10 '>
        {/* 1st Section */}
        <div className="flex flex-col lg:flex-row md:flex-row xl:flex-row items-center justify-between mx-auto xl:px-10 xl:py-20 gap-0 md:gap-20 lg:gap-20 xl:gap-20 xl:justify-between">
        ...
        {/* 2nd Section */}
        <div className="flex flex-col-reverse md:flex-row-reverse lg:flex-row-reverse xl:flex-row-reverse items-center justify-between mx-auto xl:px-10 xl:py-20 gap-0 md:gap-20 lg:gap-20 xl:gap-20">
          ...
          <div className="xl:w-[50%] lg:w-[50%] xl:pb-0 md:w-[50%] ">
            ...
            <span className={`${outfitLight.className} xl:text-left text-justify text-slate-900 text-sm md:text-sm xl:text-[16px]  xl:w-[70%] `}>
          ...
          {/* Image */}
          <div className="xl:w-[50%] lg:w-[50%] w-full h-full md:w-[50%] xl:mt-[120px]">
            <Image 
              alt='services'
        ...
        {/* 4th Section */}
        <div className="flex flex-col-reverse md:flex-row-reverse lg:flex-row-reverse xl:flex-row-reverse items-center justify-between mx-auto xl:px-10 xl:py-20 gap-0 md:gap-20 lg:gap-20 xl:gap-20 mt-10 md:mt-0 lg:mt-0 xl:mt-0">
          ...
          <div className="xl:w-[50%] lg:w-[50%] w-full h-full md:w-[50%] xl:mt-[50px]">
            <Image 
              alt='services'
              className='relative xl:h-full xl:w-[80%] w-full h-full md:-mt-[265px] xl:mt-[0px] mx-auto'
            src={imgfourth} 
            width={800}
            height={600} 
            priority/>
        ...
        <div className="flex flex-col lg:flex-row md:flex-row xl:flex-row items-center justify-between mx-auto xl:px-10 xl:py-20 gap-0 md:gap-20 lg:gap-20 xl:gap-20 mt-20 md:mt-0 lg:mt-0 xl:mt-0">
          ...
          <div className="xl:w-[50%] lg:w-[50%] w-full h-full md:w-[50%] xl:mt-[0px]">
            <Image 
              alt='services'
              className='relative xl:h-full xl:w-[80%] w-full h-full md:-mt-[265px] xl:-mt-[90px] mx-auto'
            src={imgFifth} 
            width={800}
            height={600} 
            priority/>
        ...
        {/* 6th Section */}
        <div className="flex flex-col md:flex-row-reverse lg:flex-row-reverse xl:flex-row-reverse items-center justify-between mx-auto xl:px-10 xl:py-20 gap-0 md:gap-20 lg:gap-20 xl:gap-20 mt-5 md:mt-0 lg:mt-0 xl:mt-0">
