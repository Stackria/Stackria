  ...
  return (
    <section >
      ...
      <section className=''>
        ...
        <section className="flex flex-col-reverse lg:flex-row md:flex-row xl:flex-row items-center justify-between mx-auto xl:py-20 xl:gap-20 gap-10">
          {/* Hero text */}
          <div  className="xl:w-[50%] lg:w-[50%] pb-10 xl:pb-0 px-5 xl:px-12 xl:-mt-10 md:w-[45%] md:mt-24">
            <h1 
            ...
            <span className={`${outfitLight.className} xl:text-left text-justify text-slate-800 text-[15px] md:text-[16px] xl:text-[16px]  xl:w-[70%] `}>
          ...
          {/* Image */}
          <div className="xl:w-[50%] lg:w-[50%] w-full h-full md:w-[55%] md:-mt-10">
            <Image alt='about-us'
        ...
        <section class="flex flex-col xl:flex-row gap-10 md:flex-row lg:py-20 xl:px-20 item-center mx-auto bg-slate-50 px-7 py-10" style={{ backgroundImage: 'url(/images/bg-cta0.svg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className="xl:px-20 py-10">
              ...
              <p className={`${outfitLight.className} xl:text-left text-left text-slate-800 text-[15px] xl:text-[16px] md:text-[16px] xl:w-[100%]`}>
        ...
        <section className="flex flex-col xl:px-7 py-10">
          ...
          <div className='flex flex-col md:flex-row md:flex-wrap lg:flex-row xl:flex-row px-5 justify-between gap-10 '>
            <div className="bg-slate-50 rounded-md py-10 px-5 xl:w-[100%] flex-1 min-w-[250px]">
              ...
              <p className={`${outfitLight.className}  xl:text-left text-left text-slate-800 text-[15px] md:text-[16px] xl:text-[16px]`}>
